...
cell xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwidth_converter_0 {
  ...
  s_axis_tdata [get_concat_pin [list adc_dac/adc1 [get_constant_pin 0 2] adc_dac/adc2 [get_constant_pin 0 2]]]
...
cell xilinx.com:ip:axis_clock_converter:1.1 axis_clock_converter_1 {
  ...
  m_axis_aresetn proc_sys_reset_adc_clk/peripheral_aresetn
}
...
connect_pins adc_dac/dac1 [get_slice_pin axis_dwidth_converter_1/m_axis_tdata 13 0]
connect_pins adc_dac/dac2 [get_slice_pin axis_dwidth_converter_1/m_axis_tdata 29 16]
...
# create blocks
group_bd_cells xadc_block [get_bd_cells axi_clk_conv_xadc] [get_bd_cells xadc]
group_bd_cells dma2dac_block [get_bd_cells slice_29_16_axis_dwidth_converter_1_m_axis_tdata] [get_bd_cells slice_13_0_axis_dwidth_converter_1_m_axis_tdata] [get_bd_cells axis_dwidth_converter_1] [get_bd_cells axis_clock_converter_1]
group_bd_cells adc2dma_block [get_bd_cells axis_clock_converter_0] [get_bd_cells concat_adc1_dout_adc2_dout] [get_bd_cells const_v0_w2] [get_bd_cells axis_dwidth_converter_0] [get_bd_cells tlast_gen_0]
group_bd_cells dma_block [get_bd_cells axi_dma_0] [get_bd_cells dma_interconnect]
